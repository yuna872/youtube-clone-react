  ...
  return (
    <div className="flex flex-row">
      ...
      <div className="flex flex-col">
        <p className="text-youtubeWhite text-title">{video.title}</p>
        <p className="text-youtubeWhite text-desc py-[12px]">{video.channelTitle}</p>
        <p className="text-youtubeGray text-desc">{video.description}</p>
      </div>
    </div>
  );
}
